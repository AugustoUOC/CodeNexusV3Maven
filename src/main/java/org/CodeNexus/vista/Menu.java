package org.CodeNexus.vista;

import org.CodeNexus.modelo.Datos;

import java.sql.SQLException;
import java.text.ParseException;

import static org.CodeNexus.utilidad.Teclado.pedirInt;
        ...
        while(!salirMenuSocios) {
            ...
            switch (opcion) {
                case 1:
                    ...
                    break;
                case 2:
                    int idSocio = pedirInt("Ingrese el ID del socio cuyo seguro quieres modificar: ");
                ...
                case 4:
                    ...
                    int opcion2 = pedirInt("Cual listado de socios quieres elegir: ");
                    switch (opcion2){
                        case 1:
                            Datos.mostrarSocios();
                            break;

...
import org.CodeNexus.modelo.Federado;
import org.CodeNexus.modelo.Infantil;
import org.CodeNexus.modelo.Socio;
...
public class SocioJPAController implements Serializable {
    ...
    public List<Socio> mostrarListaSocios(List<Socio> listaSocios) {
